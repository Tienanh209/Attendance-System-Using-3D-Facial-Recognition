...
# 300,1500
    def run_face_recognition_3d_with_anti_spoofing(self, embeddings_dir='../../assets/DataEmbeddings/',
        ...
        # Đổi tên phương thức để phù hợp hơn
        ...
        try:
            while True:
                ...
                for future in face_futures:
                    ...
                    # Chỉ điểm danh nếu nhận diện thành công
                    if person_id != "Unknown" and confidence > similarity_threshold:
                        detected_ids.append(person_id)
                        current_time = datetime.now()

                        # Kiểm tra nếu đã đủ 0.5 giây trước khi nhận diện lại người này
