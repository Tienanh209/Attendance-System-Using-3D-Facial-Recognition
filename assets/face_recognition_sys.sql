...
CREATE TABLE `subject` (
  `id_subject` varchar(8) NOT NULL PRIMARY KEY,
...
CREATE TABLE `teacher` (
  `id_teacher` varchar(8) NOT NULL PRIMARY KEY,
  `pwd` varchar(8) DEFAULT NULL,
...
CREATE TABLE `class_subject` (
  `id_class_subject` varchar(8) NOT NULL PRIMARY KEY,
  `id_subject` varchar(8) DEFAULT NULL,
  `id_teacher` varchar(8) DEFAULT NULL,
  `year` varchar(9) DEFAULT NULL,
  `semester` int(11) DEFAULT NULL,
  `gr` int(11) DEFAULT NULL,
  CONSTRAINT `class_subject_ibfk_1` FOREIGN KEY (`id_subject`) REFERENCES `subject` (`id_subject`),
  CONSTRAINT `class_subject_ibfk_2` FOREIGN KEY (`id_teacher`) REFERENCES `teacher` (`id_teacher`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `session` (
  ...
  CONSTRAINT `session_ibfk_1` FOREIGN KEY (`id_class_subject`) REFERENCES `class_subject` (`id_class_subject`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `register` (
  ...
  PRIMARY KEY (`id_student`, `id_class_subject`),
  CONSTRAINT `register_ibfk_1` FOREIGN KEY (`id_student`) REFERENCES `student` (`id_student`),
  CONSTRAINT `register_ibfk_2` FOREIGN KEY (`id_class_subject`) REFERENCES `class_subject` (`id_class_subject`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `attendance` (
  ...
  CONSTRAINT `attendance_ibfk_1` FOREIGN KEY (`id_student`) REFERENCES `student` (`id_student`),
  CONSTRAINT `attendance_ibfk_2` FOREIGN KEY (`id_session`) REFERENCES `session` (`id_session`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
