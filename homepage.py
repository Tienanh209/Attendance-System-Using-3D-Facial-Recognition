...
class FaceRecognitionSystem:
    def __init__(self, root):
        ...
        #======= background
        img = Image.open('ImageDesign/bg-homepage.png')
        ...
        # ==== student
        img_student = Image.open('ImageDesign/student1.png')
        ...
        # ==== report
        img_report = Image.open('ImageDesign/atten.png')
        ...
        # === recognize
        img_recognize = Image.open('ImageDesign/face_ro.png')
        ...
        # === roll-call
        img_rollcall = Image.open('ImageDesign/traindt.png')
        ...
        # === subject
        img_subject = Image.open('ImageDesign/photo.png')
        ...
        # === teacher
        img_teacher = Image.open('ImageDesign/dev.png')
